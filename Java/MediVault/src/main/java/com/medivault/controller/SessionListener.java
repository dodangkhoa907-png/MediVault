        ...
        try {
            ...
            while (names.hasMoreElements()) {
                ...
                if (name.startsWith("staffAccount_")) {
                    ...
                    if (val instanceof com.medivault.entity.Account) {
                        com.medivault.entity.Account a = (com.medivault.entity.Account) val;
                        com.medivault.util.SessionTracker.logout(a.getAccountId());
                    }
                }
            }
