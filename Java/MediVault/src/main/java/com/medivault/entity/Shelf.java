...
public class Shelf {
    ...
    public String toString() {
        return "Shelves{" + "shelfId=" + shelfId + ", shelfName=" + shelfName + ", machineSlotCode=" + machineSlotCode + ", motorId=" + motorId + ", locationNotes=" + locationNotes + ", isAutomated=" + isAutomated + '}';
    }
