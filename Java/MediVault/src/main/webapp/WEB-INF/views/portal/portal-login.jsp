...
.logo-name{font-size:22px;font-weight:900;letter-spacing:-.4px}
.logo-name span{color:var(--teal)}
.logo-sub{text-align:center;font-size:10.5px;font-weight:700;letter-spacing:2px;text-transform:uppercase;color:#94a3b8;margin-bottom:26px}
...
label{font-size:12.5px;font-weight:700;color:#334155;display:block;margin-bottom:7px}
.phone-wrap{position:relative}
.phone-wrap .ic{position:absolute;left:14px;top:50%;transform:translateY(-50%);font-size:17px}
input[type=tel]{width:100%;border:1.5px solid var(--border);border-radius:14px;padding:14px 14px 14px 44px;font-size:17px;font-weight:700;font-family:inherit;letter-spacing:1px;outline:none;transition:border .18s}
