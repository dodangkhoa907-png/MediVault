<%@ page contentType="text/html;charset=UTF-8" language="java" pageEncoding="UTF-8" %>
  <% boolean isNewAccount=(session.getAttribute("pendingNewAccount") !=null); boolean
    isLogin=(session.getAttribute("pendingAccount") !=null); if (!isNewAccount && !isLogin) {
    response.sendRedirect(request.getContextPath() + "/login" ); return; } java.lang.String context=isNewAccount
    ? "new-account" : "login" ; java.lang.String targetEmail="" ; if (isNewAccount) { Object
    pna=session.getAttribute("pendingNewAccount"); if (pna instanceof com.medicare.entity.Account)
    targetEmail=((com.medicare.entity.Account) pna).getEmail(); } else { Object
    pa=session.getAttribute("pendingAccount"); if (pa instanceof com.medicare.entity.Account)
    targetEmail=((com.medicare.entity.Account) pa).getEmail(); } java.lang.String maskedEmail=targetEmail; if
    (targetEmail !=null && targetEmail.contains("@")) { int atIdx=targetEmail.indexOf('@'); java.lang.String
    local=targetEmail.substring(0, atIdx); java.lang.String domain=targetEmail.substring(atIdx);
      ...
      <style>
        ...
        *::after {
        ...
        @keyframes iconPulse {
          ...
          50% {
            box-shadow: 0 8px 32px rgba(58, 189, 224, .5)
          }
        }
        ...
        .otp-box:focus {
          ...
          box-shadow: 0 0 0 3px rgba(58, 189, 224, .15);
        ...
        .btn-verify:hover:not(:disabled) {
          ...
          box-shadow: 0 8px 28px rgba(21, 88, 168, .3)
        }
    ...
    <body>
      <%@ include file="/WEB-INF/views/loading.jsp" %>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <% if (errMsg !=null) { %>
              <div class="msg-box msg-err">⚠️ <%= errMsg %>
              </div>
              <% } %>
                <% if (infoMsg !=null) { %>
                  <div class="msg-box msg-ok">✅ <%= infoMsg %>
                  </div>
                  <% } %>
                    ...
                    <form method="post" action="${pageContext.request.contextPath}/otp-verify" id="otpForm">
                      ...
                      <div class="timer-wrap">
                        ...
                        <span class="timer-text">Hết hạn sau <span class="timer-num"
                            id="timerDisplay">05:00</span></span>
                      </div>
                      ...
                      <div class="actions">
                        ...
                        <a href="${pageContext.request.contextPath}/<%= isNewAccount ? " accounts?action=new" : (isStaff
                          ? "staff-login" : "login" ) %>" class="btn-back">← Quay lại</a>
                      </div>
                    </form>
          </div>
        </div>
