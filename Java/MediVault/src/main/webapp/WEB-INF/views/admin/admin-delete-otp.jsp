...
.step-badge{display:inline-flex;align-items:center;gap:6px;background:#FEF2F2;border:1px solid #FECACA;
  border-radius:20px;padding:5px 14px;margin-bottom:14px;font-size:12px;font-weight:750;color:var(--red);}
h2{font-family:'Lora',serif;font-size:24px;color:var(--ink);margin-bottom:6px}
...
.target-name{font-size:13px;font-weight:750;color:#991B1B}
...
.err-box{background:#FEF2F2;border:1px solid #FECACA;border-radius:10px;
  padding:10px 14px;margin-bottom:12px;font-size:13px;color:#991B1B;font-weight:750;}
...
.otp-input{width:46px;height:52px;border:2px solid var(--border);border-radius:11px;
  font-family:'Plus Jakarta Sans',sans-serif;font-size:22px;font-weight:750;color:var(--ink);
...
.btn-cancel{padding:13px 16px;background:#fff;color:var(--muted);border:1.5px solid var(--border);
  border-radius:12px;font-family:'Plus Jakarta Sans',sans-serif;font-size:14px;font-weight:750;
...
.resend-btn{background:none;border:none;color:var(--red);font-family:'Plus Jakarta Sans',sans-serif;
  font-size:12.5px;font-weight:750;cursor:pointer;padding:0;}
