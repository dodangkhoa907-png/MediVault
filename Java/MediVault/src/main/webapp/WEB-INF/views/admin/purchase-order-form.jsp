...
<title>Tạo đơn đặt hàng — MediCare</title>
...
.content{max-width:560px;margin:28px auto;padding:0 20px 40px}
...
<div class="topbar">
  ...
  <span class="topbar-title">Tạo đơn mới</span>
  <div class="topbar-right"><div class="user-av-sm"><%= initials %></div></div>
</div>

<div class="content">
  <div class="page-title">📑 Tạo đơn đặt hàng mới</div>
  <div class="page-sub">Tạo đơn trước, sau đó vào Kho thuốc → chọn thuốc → "Thêm lô mới" để gắn lô hàng vào đơn này.</div>
  ...
  <form method="post" action="${pageContext.request.contextPath}/purchase-orders">
    ...
    <div class="card">
      <div class="form-group">
        ...
        <span class="form-hint">Không thấy nhà cung cấp cần tìm? Vào mục Nhà cung cấp để thêm trước.</span>
      </div>
      <div class="form-group">
        <label class="form-label">Ghi chú</label>
        <textarea name="notes" rows="3" placeholder="VD: Đặt hàng định kỳ tháng 6, giao trong 3 ngày..."></textarea>
      </div>
    </div>
    <div class="form-actions">
      <a href="${pageContext.request.contextPath}/purchase-orders" class="btn-cancel">Hủy</a>
      <button type="submit" class="btn-save">📑 Tạo đơn đặt hàng</button>
    </div>
  </form>
</div>
</body>
