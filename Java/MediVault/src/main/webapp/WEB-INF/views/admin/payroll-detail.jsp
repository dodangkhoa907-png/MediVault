...
@keyframes slideIn{from{transform:translateX(60px);opacity:0}to{transform:translateX(0);opacity:1}}
  ...
  <header class="topbar"><div style="font-size:15px">💰</div>
    ...
    <div class="topbar-right">
      <a href="${pageContext.request.contextPath}/payroll" style="padding:7px 16px;border:1.5px solid var(--border);border-radius:8px;font-family:inherit;font-size:13px;font-weight:750;color:var(--muted);text-decoration:none">← Quay lại</a>
    </div>
  </header>
    ...
    <div class="table-card" style="margin-bottom:16px">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:0;padding:0">
        <div style="padding:14px 20px;border-right:1px solid var(--border);border-bottom:1px solid var(--border)">
          <div style="font-size:11px;font-weight:750;color:var(--muted);text-transform:uppercase;letter-spacing:.5px;margin-bottom:4px">Ngày công</div>
          <div style="font-size:20px;font-weight:800">${payroll.totalWorkedDays}/${payroll.totalScheduledDays} ngày</div>
          <div style="font-size:11px;color:var(--muted);margin-top:2px">Tổng ${payroll.totalHours}h thực tế</div>
        </div>
        <div style="padding:14px 20px;border-bottom:1px solid var(--border)">
          <div style="font-size:11px;font-weight:750;color:var(--muted);text-transform:uppercase;letter-spacing:.5px;margin-bottom:4px">Làm thêm giờ</div>
          <div style="font-size:20px;font-weight:800">${payroll.overtimeHours}h</div>
        ...
        <div style="padding:14px 20px;border-right:1px solid var(--border)">
          <div style="font-size:11px;font-weight:750;color:var(--muted);text-transform:uppercase;letter-spacing:.5px;margin-bottom:4px">Cơ cấu thu nhập</div>
        ...
        <div style="padding:14px 20px;display:flex;flex-direction:column;justify-content:center;align-items:center">
          <div style="font-size:12px;font-weight:750;color:var(--muted);text-transform:uppercase;letter-spacing:.5px">THỰC NHẬN</div>
          <div style="font-size:32px;font-weight:800;color:var(--green);margin-top:6px"><fmt:formatNumber value="${payroll.netSalary}" type="number" maxFractionDigits="0"/>đ</div>
        </div>
      </div>
    </div>
