...
.page-head h1{font-family:'Lora',serif;font-size:26px;color:var(--ink)}
...
.btn-back{display:inline-flex;align-items:center;gap:7px;padding:9px 18px;background:var(--white);border:1.5px solid var(--border);border-radius:11px;font-family:'Plus Jakarta Sans',sans-serif;font-size:13.5px;font-weight:750;color:var(--navy);text-decoration:none;transition:all .2s}
...
.stat-mini-val{font-family:'Lora',serif;font-size:24px;color:var(--ink);line-height:1}
...
.card-title{font-family:'Lora',serif;font-size:18px;color:var(--ink)}
...
.filter-select{padding:8px 12px;background:var(--surface);border:1.5px solid var(--border);border-radius:10px;font-family:'Plus Jakarta Sans',sans-serif;font-size:13px;color:var(--ink);outline:none;cursor:pointer;transition:all .18s}
...
.tbl th{padding:10px 16px;background:var(--surface);border-bottom:1px solid var(--border);font-size:11px;font-weight:750;text-transform:uppercase;letter-spacing:.6px;color:var(--muted);text-align:left;white-space:nowrap}
...
.act-btn{padding:5px 11px;border-radius:7px;font-size:12px;font-weight:750;text-decoration:none;cursor:pointer;border:none;font-family:'Plus Jakarta Sans',sans-serif;transition:all .15s}
...
.form-card-head h2{font-family:'Lora',serif;font-size:17px;color:var(--ink);margin-bottom:2px}
...
.field-label{font-size:12.5px;font-weight:750;color:var(--navy);letter-spacing:.3px}
.field-label .req{color:var(--red)}.field-label .hint{font-size:11.5px;font-weight:400;color:var(--muted)}
.field-input{width:100%;padding:11px 14px;background:#fff;border:1.5px solid var(--border);border-radius:11px;font-family:'Plus Jakarta Sans',sans-serif;font-size:13.5px;color:var(--ink);outline:none;transition:all .18s}
...
.btn-submit{display:inline-flex;align-items:center;gap:7px;padding:11px 22px;background:linear-gradient(135deg,var(--blue),#0D3F85);color:#fff;border:none;border-radius:11px;font-family:'Plus Jakarta Sans',sans-serif;font-size:14px;font-weight:750;cursor:pointer;transition:all .22s;box-shadow:0 4px 14px rgba(21,88,168,.25)}
...
.btn-cancel{padding:11px 20px;background:var(--white);border:1.5px solid var(--border);border-radius:11px;font-family:'Plus Jakarta Sans',sans-serif;font-size:13.5px;font-weight:750;color:var(--muted);text-decoration:none;transition:all .18s}
...
.err-list h3{font-size:13px;font-weight:750;color:#991B1B;margin-bottom:8px}.err-list li{font-size:12.5px;color:#B91C1C;margin-left:16px;margin-bottom:3px}
...
.detail-card-title{font-family:'Lora',serif;font-size:16px;color:var(--ink)}.detail-card-sub{font-size:12px;color:var(--muted);margin-top:2px}
...
.df-label{font-size:10.5px;font-weight:750;text-transform:uppercase;letter-spacing:.6px;color:var(--muted)}
.df-value{font-size:13.5px;font-weight:750;color:var(--ink)}.df-value.empty{color:var(--muted);font-style:italic;font-weight:400}
.detail-actions{display:flex;gap:10px;margin-top:16px;flex-wrap:wrap}
.days-left{display:inline-flex;align-items:center;gap:4px;padding:3px 10px;border-radius:20px;font-size:11.5px;font-weight:750}
...
<div class="main">
  <header class="topbar">
    ...
    <div class="topbar-right">
      <a href="${pageContext.request.contextPath}/accounts" class="topbar-user" style="font-size:13px;font-weight:750;color:var(--muted);text-decoration:none;padding:6px 12px;border:1.5px solid var(--border);border-radius:8px;">← Danh sách</a>
        ...
        <table class="tbl">
          ...
          <tbody>
            ...
            <tr><td colspan="6">
              <div class="empty">
                <div class="ei">✅</div>
                <div style="font-weight:750;margin-bottom:6px">Thùng rác trống</div>
            ...
            <tr>
              ...
              <td><span style="font-size:12px;font-weight:750;color:var(--muted)"><%= roleName %></span></td>
