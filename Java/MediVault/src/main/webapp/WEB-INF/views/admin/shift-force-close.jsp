...
.card-title{font-family:'Plus Jakarta Sans',sans-serif;font-size:18px;color:var(--ink)}
...
/* ── Shift-specific styles ── */
        ...
        .fc-info-label { font-size: 11px; color: #94A3B8; font-weight:750; text-transform: uppercase; letter-spacing: .5px; }
        .fc-info-val   { font-size: 13px; color: #0B1628; font-weight:750; margin-top: 4px; }
        ...
        .btn-cancel {
            ...
            padding: 11px 20px; font-size: 14px; font-weight:750;
