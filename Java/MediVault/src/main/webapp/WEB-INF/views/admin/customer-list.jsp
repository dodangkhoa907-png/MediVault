...
.filter-row input{flex:1;max-width:320px;height:38px;padding:0 12px;border:1.5px solid var(--border);border-radius:9px;font-family:'Plus Jakarta Sans',sans-serif;font-size:13px;outline:none}
              ...
              <tr data-name="${fn:toLowerCase(cu.customerName)} ${cu.phone} ${cu.email}"
                ...
                <td>
                  <div class="cell-user">
                    ...
                    <span style="font-weight:750">${cu.customerName}</span>
                  </div>
                </td>
