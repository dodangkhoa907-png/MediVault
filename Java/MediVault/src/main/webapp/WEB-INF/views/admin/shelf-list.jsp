...
.logo-text{font-size:16px;font-weight:800;color:#fff;line-height:1.1}.logo-sub{font-size:10px;color:rgba(255,255,255,.45);letter-spacing:.5px;text-transform:uppercase}
...
.nav-item:hover{background:rgba(255,255,255,.07);color:#fff}.nav-item.active{background:rgba(58,189,224,.15);color:#fff;border:1px solid rgba(58,189,224,.2)}
...
.btn-primary{height:36px;padding:0 16px;background:var(--blue);color:#fff;border:none;border-radius:9px;font-size:13px;font-weight:700;text-decoration:none;display:inline-flex;align-items:center;gap:6px}
...
.toast-bar{padding:12px 18px;border-radius:11px;margin-bottom:18px;font-size:13.5px;font-weight:600}
...
td{padding:14px 16px;font-size:13.5px;vertical-align:middle}.td-id{color:var(--muted);font-size:12px;font-weight:700}.td-muted{color:var(--muted);font-size:12.5px}
...
.btn-del{height:30px;padding:0 12px;background:#FEF2F2;border:1.5px solid #FECACA;border-radius:7px;font-size:12px;font-weight:700;color:var(--red);cursor:pointer;display:inline-flex;align-items:center;gap:4px;font-family:inherit}
...
.section-tab{padding:8px 16px;border-radius:9px;font-size:13px;font-weight:600;color:var(--muted);text-decoration:none;white-space:nowrap}
...
<div id="delModal" style="display:none;position:fixed;inset:0;background:rgba(11,22,40,.5);z-index:200;align-items:center;justify-content:center">
  <div style="background:#fff;border-radius:16px;padding:28px 32px;max-width:400px;width:90%">
    ...
    <div style="font-size:16px;font-weight:700;margin-bottom:8px">Xóa vị trí kệ?</div>
    <div style="font-size:13px;color:var(--muted);margin-bottom:20px" id="delMsg"></div>
    <div style="display:flex;gap:10px;justify-content:flex-end">
      <button onclick="document.getElementById('delModal').style.display='none'" style="height:36px;padding:0 16px;border:1.5px solid var(--border);border-radius:9px;background:#fff;font-weight:600;cursor:pointer;font-family:inherit">Hủy</button>
      <a id="delLink" href="#" style="height:36px;padding:0 16px;background:#DC2626;color:#fff;border-radius:9px;font-weight:700;text-decoration:none;display:inline-flex;align-items:center">Xóa</a>
    </div>
  </div>
</div>
<script>
