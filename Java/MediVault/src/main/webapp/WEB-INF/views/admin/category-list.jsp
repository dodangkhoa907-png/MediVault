...
.td-id{color:var(--muted);font-size:12px;font-weight:700}
.td-desc{color:var(--muted);font-size:12.5px}
.actions{display:flex;gap:6px}
.btn-edit{height:30px;padding:0 12px;background:var(--cyan-soft);border:1.5px solid rgba(58,189,224,.3);border-radius:7px;font-size:12px;font-weight:700;color:var(--blue);text-decoration:none;display:inline-flex;align-items:center;gap:4px;transition:all .15s}
.btn-edit:hover{background:#D0F4FC;border-color:var(--cyan)}
.btn-del{height:30px;padding:0 12px;background:#FEF2F2;border:1.5px solid #FECACA;border-radius:7px;font-size:12px;font-weight:700;color:var(--red);cursor:pointer;display:inline-flex;align-items:center;gap:4px;transition:all .15s;font-family:inherit}
...
<div id="delModal" style="display:none;position:fixed;inset:0;background:rgba(11,22,40,.5);z-index:200;align-items:center;justify-content:center">
  <div style="background:#fff;border-radius:16px;padding:28px 32px;max-width:400px;width:90%;box-shadow:0 20px 60px rgba(0,0,0,.2)">
    ...
    <div style="font-size:16px;font-weight:700;color:var(--ink);margin-bottom:8px">Xóa danh mục?</div>
    <div style="font-size:13px;color:var(--muted);margin-bottom:20px" id="delMsg"></div>
    <div style="display:flex;gap:10px;justify-content:flex-end">
      <button onclick="document.getElementById('delModal').style.display='none'" style="height:36px;padding:0 16px;border:1.5px solid var(--border);border-radius:9px;background:#fff;font-size:13px;font-weight:600;cursor:pointer;font-family:inherit">Hủy</button>
      <a id="delLink" href="#" style="height:36px;padding:0 16px;background:#DC2626;color:#fff;border-radius:9px;font-size:13px;font-weight:700;text-decoration:none;display:inline-flex;align-items:center">Xóa</a>
    </div>
  </div>
</div>
