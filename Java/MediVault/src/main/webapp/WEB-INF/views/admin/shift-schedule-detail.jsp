...
.btn-back{display:inline-flex;align-items:center;gap:6px;padding:8px 16px;
  ...
  font-family:'Plus Jakarta Sans',sans-serif;font-size:13px;font-weight:750;color:var(--muted);
...
.ch-name{font-size:18px;font-weight:750}
.ch-type{font-size:13px;opacity:.75;margin-top:2px}
.ch-badge{margin-left:auto;padding:5px 14px;border-radius:20px;font-size:12px;font-weight:750}
...
.info-label{font-size:10.5px;font-weight:750;color:var(--muted);letter-spacing:.5px;text-transform:uppercase;margin-bottom:4px}
.info-val{font-size:14px;font-weight:750;color:var(--ink)}
.notes-sec{padding:0 26px 22px}
.notes-label{font-size:11px;font-weight:750;color:var(--muted);text-transform:uppercase;letter-spacing:.5px;margin-bottom:6px}
...
.btn-act{flex:1;padding:11px;border-radius:10px;border:none;font-family:'Plus Jakarta Sans',sans-serif;
  font-size:13px;font-weight:750;cursor:pointer;transition:all .18s;text-align:center;text-decoration:none;display:flex;align-items:center;justify-content:center;gap:5px}
...
.toast{position:fixed;top:20px;right:24px;padding:12px 20px;border-radius:11px;font-size:13.5px;font-weight:750;
