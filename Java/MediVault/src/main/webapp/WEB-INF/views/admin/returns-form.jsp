...
.btn-mini{padding:0 16px;background:var(--blue);color:#fff;border:none;border-radius:9px;font-weight:700;font-size:13px;cursor:pointer;font-family:inherit}
...
.batch-pick .exp{color:var(--red);font-weight:700;float:right}
      ...
      <div class="card">
        ...
        <div class="form-group">
          ...
          <select name="returnType" class="form-select" required>
            <option value="EXPIRED_DESTROY">🗑️ Hết hạn — tiêu hủy</option>
            <option value="RECALL">⚠️ Thu hồi theo yêu cầu NSX/cơ quan y tế</option>
          </select>
        </div>
        <div class="form-group">
