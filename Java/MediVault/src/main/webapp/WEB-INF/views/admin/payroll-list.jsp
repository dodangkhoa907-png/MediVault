...
<title>Bảng lương — MediVault</title>
  ...
  <header class="topbar"><div style="font-size:15px">💰</div><span class="topbar-title">Bảng lương</span>
    <div class="topbar-right">
      ...
      <a href="${pageContext.request.contextPath}/payroll?action=generate&month=${month}&year=${year}"
         ...
         style="padding:7px 16px;background:var(--green);color:#fff;border-radius:8px;font-size:13px;font-weight:700;text-decoration:none">
        ⚡ Tính lương tháng
      </a>
    </div>
  </header>
  <div class="content">
    ...
    <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:12px;margin-bottom:20px">
      ...
      <div style="background:var(--white);border:1px solid var(--border);border-radius:var(--radius);padding:14px 18px">
        ...
        <div style="font-size:20px;font-weight:900;color:var(--amber);margin-top:4px">${draftCount}</div>
      </div>
      <div style="background:var(--white);border:1px solid var(--border);border-radius:var(--radius);padding:14px 18px">
        <div style="font-size:11px;font-weight:700;color:var(--muted);text-transform:uppercase;letter-spacing:.5px">Đã xác nhận</div>
        <div style="font-size:20px;font-weight:900;color:var(--blue);margin-top:4px">${confirmedCount}</div>
      </div>
      <div style="background:var(--white);border:1px solid var(--border);border-radius:var(--radius);padding:14px 18px">
        <div style="font-size:11px;font-weight:700;color:var(--muted);text-transform:uppercase;letter-spacing:.5px">Đã trả</div>
        <div style="font-size:20px;font-weight:900;color:var(--green);margin-top:4px">${paidCount}</div>
      </div>
    </div>
