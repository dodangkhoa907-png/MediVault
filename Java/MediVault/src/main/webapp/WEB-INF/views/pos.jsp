          ...
          <head>
            ...
            <style>
              ...
              *::after {
              ...
              .cc-btn-act.select-btn {
                border-color: var(--green);
                color: var(--green);
              }

              .cc-btn-act.select-btn:hover {
                background: #ecfdf5;
              }
          ...
          <body>
            <%@ include file="/WEB-INF/views/loading.jsp" %>
              ...
              <aside class="sidebar" id="mainSidebar">
                ...
                <a href="javascript:void(0)" onclick="openCustomerCrudModal()" class="sb-btn" id="sbCustomerBtn">
                  <span class="sb-icon">👥</span>
                  <span class="sb-label">Khách hàng</span>
                  <span class="sb-tip">Khách hàng (F4)</span>
                </a>
                <div class="sb-bottom">
           ...
           padding:15px;box-shadow:0 8px 32px rgba(0,0,0,.4);z-index:9999">
                      <% if (isLoggedIn) { %>
                        ...
                        <a href="<%= ctx %>/staff-dashboard"
                          style="display:block;padding:8px 11px;background:rgba(255,255,255,.1);border-radius:8px;color:#93c5fd;font-size:12.5px;font-weight:600;text-decoration:none;margin-bottom:5px;text-align:center">📅
                          Xem lịch ca</a>
                        <button onclick="openEndShiftModal();toggleCheckinPanel();"
                          style="display:block;width:100%;padding:8px 11px;background:rgba(239,68,68,.15);border-radius:8px;color:#fca5a5;font-size:12.5px;font-weight:600;text-align:center;border:none;cursor:pointer;font-family:inherit">⏻
                          Kết thúc ca</button>
                        <% } else { %>
                          ...
                          <button onclick="openFaceModal();toggleCheckinPanel();"
                            style="width:100%;padding:10px;background:linear-gradient(135deg,#059669,#047857);border:none;border-radius:8px;color:#fff;font-size:13px;font-weight:700;cursor:pointer;font-family:inherit;margin-bottom:6px;display:flex;align-items:center;justify-content:center;gap:6px">
                            📷 Điểm danh khuôn mặt
                          </button>
              ...
              <div class="center">
                ...
                <div class="topbar">
                  <div class="search-wrap">
                    <input type="text" id="searchInput" placeholder="Tìm thuốc theo tên hoặc mã vạch…"
                      autocomplete="off">
                  </div>
                  <!-- Station badge -->
                ...
                <% if (!isLoggedIn) { %>
                  <div id="checkinBanner"
                    ...
                    <button onclick="openFaceModal()"
                      style="padding:8px 18px;background:#f59e0b;border:none;border-radius:9px;color:#fff;font-size:13px;font-weight:700;cursor:pointer;font-family:inherit;white-space:nowrap;flex-shrink:0;display:flex;align-items:center;gap:6px">
                      📷 Điểm danh ngay
                    </button>
                  </div>
                  <% } %>
                ...
                <div class="esr-box">
                  ...
                  <div class="esr-body">
                    ...
                    <div class="esr-left">
                      ...
                      <div class="esr-note">💡 QR và Thẻ không ảnh hưởng đến két tiền mặt tại quầy. Chỉ tính vào doanh
                        số nhân viên.</div>
                    </div>
              ...
              <!-- CUSTOMER CRUD MODAL -->
              <div class="cc-modal-bd" id="customerCrudModal">
                <div class="cc-modal-box">
                  <div class="cc-modal-head">
                    <div class="cc-modal-head-title"><span>👥</span> Quản lý khách hàng</div>
                    <button class="cc-modal-hclose" onclick="closeCustomerCrudModal()">✕</button>
                  </div>
                  <div class="cc-modal-body">
                    <!-- VIEW 1: LIST -->
                    <div class="cc-view active" id="ccListView">
                      <div class="cc-list-top">
                        <div class="cc-search-wrap">
                          <input type="text" id="ccSearchInput" placeholder="Tìm khách hàng theo tên hoặc SĐT..."
                            oninput="onCcSearchInput()" autocomplete="off">
                        </div>
                        <button class="btn-cc-add" onclick="showCustomerForm(true)">＋ Thêm khách hàng</button>
                      </div>
                    ...
                    <!-- VIEW 2: FORM -->
                    <div class="cc-view" id="ccFormView">
                      <input type="hidden" id="ccCustomerId" value="0">
                      <div class="cc-form-card">
                        <div class="cc-form-title">Thông tin cơ bản</div>
                        <div class="cc-form-group">
                          <label class="cc-form-label">Họ và tên <span>*</span></label>
                          <input type="text" id="ccCustomerName" class="cc-form-input" required
                            placeholder="Nhập tên khách hàng...">
                        </div>
                        <div class="cc-form-row">
                          <div class="cc-form-group">
                            <label class="cc-form-label">Số điện thoại</label>
                            <input type="text" id="ccPhone" class="cc-form-input" placeholder="09xxxxxxxx">
                          </div>
                          <div class="cc-form-group">
                            <label class="cc-form-label">Email</label>
                            <input type="email" id="ccEmail" class="cc-form-input" placeholder="khachhang@email.com">
                          </div>
                        </div>
                        <div class="cc-form-row">
                          <div class="cc-form-group">
                            <label class="cc-form-label">Ngày sinh</label>
                            <input type="date" id="ccDateOfBirth" class="cc-form-input">
                          </div>
                          <div class="cc-form-group">
                            <label class="cc-form-label">Giới tính</label>
                            <select id="ccGender" class="cc-form-select">
                        ...
                        <div class="cc-form-group">
                          <label class="cc-form-label">Địa chỉ</label>
                          <input type="text" id="ccAddress" class="cc-form-input" placeholder="Địa chỉ thường trú...">
                        </div>
                        <div class="cc-form-row">
                          <div class="cc-form-group">
                            <label class="cc-form-label">CCCD/CMND</label>
                            <input type="text" id="ccNationalId" class="cc-form-input" placeholder="Số căn cước...">
                          </div>
                          <div class="cc-form-group">
                            <label class="cc-form-label">Nghề nghiệp</label>
                            <input type="text" id="ccOccupation" class="cc-form-input" placeholder="Nghề nghiệp...">
                          </div>
                        </div>
                      </div>

                      <div class="cc-form-card">
                        <div class="cc-form-title">Thông tin y tế (không bắt buộc)</div>
                        <div class="cc-form-group">
                          <label class="cc-form-label">Tiền sử dị ứng</label>
                          <textarea id="ccAllergyHistory" rows="2" class="cc-form-textarea"
                            placeholder="Dị ứng Penicillin, Aspirin..."></textarea>
                        </div>
                        <div class="cc-form-group">
                          <label class="cc-form-label">Bệnh mạn tính</label>
                          <textarea id="ccChronicDisease" rows="2" class="cc-form-textarea"
                            placeholder="Tiểu đường, cao huyết áp, tim mạch..."></textarea>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="cc-foot" id="ccFormFoot" style="display:none">
                    <button class="cc-cancel" onclick="showCustomerList()">Quay lại</button>
                    <button class="cc-save" onclick="saveCustomer()">💾 Lưu thông tin</button>
                  </div>
                </div>
              </div>
